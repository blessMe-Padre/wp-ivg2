    ...
    <div class="container">
        <section class="contacts">
            ...
            <ul>
                ...
                <li>
                    <a class="link" href="tel:+<?= CFS()->get('contact_phone_robots') ?>"><i
                            class="icon-phone"></i><span>Телефон: <?= CFS()->get('contact_phone') ?></span></a>
                </li>
                <li>
                    <a class="link" href="tel:<?= CFS()->get('contact_phone_short_robots') ?>"><i
                            class="icon-phone"></i><span>Телефон (короткий):
                            <?= CFS()->get('contact_phone_short') ?></span></a>
                </li>
                <li>
                    <a class="link" href="<?= CFS()->get('contact_whatsapp_link') ?>"><i class="icon-whatsapp"
                            target="_blank"></i><span>WhatsApp:
